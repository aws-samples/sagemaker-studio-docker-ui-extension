"""
Setup Module to setup Python Handlers for the sagemaker_studio_docker_ui extension.
"""
...
# Original Copyright (c) Jupyter Development Team. Distributed under the terms of the Modified BSD License.
...
# Get our version
version = get_version(str(Path(HERE) / name / "_version.py"))
...
data_files_spec = [
    ...
    (
        ...
        "jupyter-config",
        "sagemaker_studio_docker_ui.json",
    ),
]
...
setup_args = dict(
    ...
    author="Sam Edwards",
    description="A JupyterLab Sagemaker Studio Docker UI extension",
